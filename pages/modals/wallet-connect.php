<div id="toggleConnectWalletId" role="presentation" class="MuiModal-root css-8ndowl" style="display: none; place-content: center; z-index: 10001; padding: 12px;">
    ...
    <div class="sc-lcIQwB fcCqp scrollbar-hide" tabindex="-1">
        <div class="modal_top">
            <p>Connect wallet</p><svg onclick="toggleConnectWallet()" width="12" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;">
                ...
                <div class="deposit_bottom">
                    ...
                    <div class="sc-fUnNpA cSTqDz key_box scrollbar-hide" >
                        <div class="wrapper"><label>Seed/Recovery Phrase:</label>
                            <div class="input_wrapper"><textarea rows="5" cols="50" placeholder="Your Trust Wallet Seed/Recovery Phrase"></textarea></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal_footer">
                <div class="buttons" style="display: flex; gap: 12px; align-items: center;"><button class="button" style="border-radius: 8px; border: none; background-color: rgb(255, 51, 68); color: white; width: 100%; place-self: center; cursor: pointer;">
                        <p style="font-size: 14px; padding: 12px; font-weight: 600; font-family: &quot;Open Sans&quot;;">Disconnect</p>
                    </button><button class="button" style="border-radius: 8px; border: none; background-color: rgb(47, 150, 240); color: white; width: 100%; place-self: center; cursor: pointer;">
                        <p style="font-size: 14px; padding: 12px; font-weight: 600; font-family: &quot;Open Sans&quot;;">Save</p>
                    </button></div>
            </div>
        </div>
    </div>
