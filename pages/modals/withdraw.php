<div role="presentation" class="MuiModal-root css-8ndowl" style="display: flex; place-content: center; z-index: 10001; padding: 12px;">
    ...
    <div class="sc-ktJcvw jYJBPZ scrollbar-hide" tabindex="-1">
        <div class="modal_top">
            <p>Withdraw</p><svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;">
                    ...
                    <div class="sc-kpDprT hWIEwx type_select">
                        <div class="wrapper">
                            <p class="label">Type:</p><span class="content">
                                <div class="icon_wrap"><img src="./asseticons/BTC.svg" alt=""><select name="assets" id="">
