<div id="toggleStakeModal1" role="presentation" class="MuiModal-root css-8ndowl" style="display: none; place-content: center; z-index: 10001; padding: 12px; overflow: scroll; scrollbar-width: none;">
    ...
    <div class="sc-cfxfQh inaFvt scrollbar-hide" tabindex="-1">
        <div class="modal_top">
            <p>Deposit</p><svg onclick="toggleStakeModal('1')" width="12" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;">
        ...
        <div class="modal_content">
            ...
            <div class="modal_footer">
                <div class="buttons" style="display: flex; gap: 12px; align-items: center;"><button onclick="toggleStakeModal('2')" class="button" style="border-radius: 8px; border: none; background-color: grey; color: white; width: 100%; place-self: center; cursor: pointer;">
...
<div id="toggleStakeModal2" role="presentation" class="MuiModal-root css-8ndowl" style="display: none; place-content: center; z-index: 10001; padding: 12px; overflow: scroll; scrollbar-width: none;">
    ...
    <div class="sc-cfxfQh inaFvt scrollbar-hide" tabindex="-1">
        <div class="modal_top">
            <p>Deposit</p><svg onclick="toggleStakeModal('2')" width="12" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.8647 0.366365C12.3532 -0.122122 13.1451 -0.122122 13.6336 0.366365C14.1221 0.854853 14.1221 1.64685 13.6336 2.13533L8.88929 6.87968L13.8743 11.8647C14.3628 12.3532 14.3628 13.1451 13.8743 13.6336C13.3858 14.1221 12.5938 14.1221 12.1053 13.6336L7.12032 8.64864L2.13533 13.6336C1.64685 14.1221 0.854853 14.1221 0.366366 13.6336C-0.122122 13.1451 -0.122122 12.3532 0.366366 11.8647L5.35136 6.87968L0.607014 2.13533C0.118527 1.64685 0.118527 0.854853 0.607014 0.366365C1.0955 -0.122122 1.8875 -0.122122 2.37598 0.366365L7.12032 5.11071L11.8647 0.366365Z" fill="rgba(255, 255, 255, 0.5)"></path>
            </svg>
        </div>
        <div class="modal_content">
