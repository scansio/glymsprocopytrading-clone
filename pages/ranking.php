        ...
        <div class="sc-bbSYpP fTjnEs">
            <div class="sc-eoVZcn kCNvFA">
                ...
                <div class="card info-card bg-dark text-white">
                    <div class="card-body">
                        <div class="prevent-wrap"><span>Minimum Deposit </span> :$5,000.00</div>
                        <div><span>Bonus </span>:$500.00</div>
                    </div>
                </div>
            </div>
            <div class="sc-eoVZcn kCNvFA">
                ...
                <div class="card info-card bg-dark text-white">
                    <div class="card-body">
                        <div class="prevent-wrap"><span>Minimum Deposit </span> :$50,000.00</div>
                        <div><span>Bonus </span>:$500.00</div>
                    </div>
                </div>
            </div>
            <div class="sc-eoVZcn kCNvFA">
                ...
                <div class="card info-card bg-dark text-white">
                    <div class="card-body">
                        <div class="prevent-wrap"><span>Minimum Deposit </span> :$100,000.00</div>
                        <div><span>Bonus </span>:$500.00</div>
                    </div>
                </div>
            </div>
            <div class="sc-eoVZcn kCNvFA">
                ...
                <div class="card info-card bg-dark text-white">
                    <div class="card-body">
                        <div class="prevent-wrap"><span>Minimum Deposit </span> :$500,000.00</div>
                        <div><span>Bonus </span>:$500.00</div>
                    </div>
                </div>
            </div>
            <div class="sc-eoVZcn kCNvFA">
                ...
                <div class="card info-card bg-dark text-white">
                    <div class="card-body">
                        <div class="prevent-wrap"><span>Minimum Deposit </span> :$1,000,000.00</div>
                        <div><span>Bonus </span>:$500.00</div>
                    </div>
                </div>
            </div>
