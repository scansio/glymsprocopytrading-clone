<div class="content">
    <div class="sc-iapVNj hueIPF">
        <div class="sc-bVHBsO jBarWy">
            <div class="top"><span class="total_balance">
                    <p>Total Balance</p>
                    <p>$0.00</p>
                </span>
                <p class="tag">Live account</p>
            </div>
            <div class="bottom" style="height: fit-content; margin-top: 120px;">
                <div class="sc-dSIJcR bzuARV">
                    <div class="categories_lines"></div>
                    <div class="categories_names"></div>
                </div>
            </div>
        </div>
        <div
            style="width: 100%; height: 100%; padding: 24px 24px 40px; background-color: rgba(255, 255, 255, 0.024); border-radius: 12px; min-height: 312px;">
            <p
                style="font-size: 14px; color: rgba(255, 255, 255, 0.5); line-height: 16px; font-weight: 600; padding-bottom: 20px;">
                Recent activity</p>
            <div>
                <div class="sc-gdyfxU iJrYGh">
                    <div class="left"><span class="left_info"><span class="left_info_title">
                                <p class="title">Deposit request</p><strong class="label">1 hour ago</strong>
                            </span>
                            <p class="left_info_value">BTC deposit of $2323 is pending approval</p>
                        </span></div>
                </div>
                <div class="sc-gdyfxU iJrYGh">
                    <div class="left"><span class="left_info"><span class="left_info_title">
                                <p class="title">Welcome</p><strong class="label">23 hours ago</strong>
                            </span>
                            <p class="left_info_value">Welcome to Glyms Pro Copy Trading</p>
                        </span></div>
                </div>
            </div>
        </div>
    ...
    <div class="sc-dSCuSI gDhvJj scrollbar-hide">
        <div class="holder">
            <div class="title" style="display: flex; justify-content: space-between; align-items: center;">
                <p>Top Assets</p>
                <div class="sc-dtBeHJ hgFdWj scrollbar-hide"><button
                        class="active">All</button><button>Fiat</button><button>Crypto</button><button>Stocks</button>
                </div>
            </div>
            <table class="sc-eulNPF HUxir">
            ...
            <div class="sc-dExXmK cJeclD"></div>
        </div>
    </div>
    <div class="sc-dSCuSI gDhvJj scrollbar-hide">
        <div class="holder">
            <div class="title" style="display: flex; justify-content: space-between; align-items: center;">
                <p>Assets</p>
                <div class="sc-bmzXxz birDzh"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-search">
                        <circle cx="11" cy="11" r="8"></circle>
                        <path d="m21 21-4.3-4.3"></path>
                    </svg><input type="text" name="" id="" placeholder="Search"></div>
            </div>
            <table class="sc-YysaK bBJQjy">
                <thead style="display: block; width: 100%; border-bottom: 1px solid rgb(33, 41, 69);">
                    <td class="head-cell symbol">
                        <div>
                            <p>Asset</p>
                        </div>
