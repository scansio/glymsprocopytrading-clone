<div id="slideIn-root">
    ...
    <div class="sc-fqkwJk jDMtnb">
        <div class="inner">
            ...
            <div class="sc-cWSIco cVHbVq">
                <div class="sc-fPXMhL fXfxHK claim_box">
                    <div class="label">
                        <p>Your referral balance:</p>
                    </div>
                    <div class="input_holder">
                        <div class="wrapper"><input type="number" placeholder="$0.00"></div><button class="sc-dLNtp etixHs btn">Claim</button>
                    </div>
                </div>
                <div class="sc-fPXMhL fXfxHK copy_box">
                    <div class="label">
                ...
                <div class="statistics"><label>Statistics</label>
                    <div class="stat_hlder">
                        <div><label>Friends invited</label>
                            <p>0</p>
                        </div>
                        <div><label>Reward claimed</label>
                            <p>$0.00</p>
                        </div>
                    </div>
                </div>
                <div class="ref_list">
                    <div class="sc-fUnNpA cSTqDz scrollbar-hide"><label for="address">Referrals</label>
                        <div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search">
                            ...
                            </svg><input type="text" placeholder="Search for a referral"></div>
                    </div>
                </div>
    ...
    <div class="sc-fqkwJk jDMtnb">
        <div class="inner">
            ...
            <div class="sc-kdBRUi kPKhbr">
                <div class="sc-fPXMhL fXfxHK claim_box" style="opacity: 1; user-select: none; pointer-events: none;">
                    <div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search">
                            <circle cx="11" cy="11" r="8"></circle>
                            <path d="m21 21-4.3-4.3"></path>
                ...
                <div class="wallet_hldr" style="display: block; position: absolute; width: 93%; scrollbar-width: none;">
                    ...
                    <div class="wrapper switch"><label style="display: flex; gap: 6px; align-items: center; flex-shrink: 0; font-weight: 500;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-link">
                                <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path>
                                <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path>
                            </svg>
                            <p style="font-weight: 500; font-size: 12px; color: rgba(255, 255, 255, 0.5);">Add new wallet</p>
                        </label></div>
                </div>
            </div>
        </div>
