<div class="sc-esYjtY iLtyI">
    ...
    <div class="sc-JrEyx kSCqsC scrollbar-hide ">
            ...
            <div class="selectable_sections">
                <div class="selectable_section">
                    <div class="sidebar_items"><a class="link" href="/dashboard.php"><span
                                class="sidebar_item active"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                ...
                                <p>Dashboard</p>
                            </span></a><a class="link" href="/deposit.php"><span class="sidebar_item"><svg
                                ...
                                <p>Deposit</p>
                            </span></a><a class="link" href="/withdraw.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <p>Withdraw</p>
                            </span></a><a class="link" href="/convert.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                ...
                                <p>Convert</p>
                            </span></a><a class="link" href="/assets.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a class="link" href="/markets.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <p>Markets</p>
                            </span></a><a class="link" href="/live-trade.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" strokeLineCap="round"
                                ...
                                <p>Live Trade</p>
                            </span></a><a class="link" href="/trade.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <p>Demo Trade</p>
                            </span></a><a class="link" href="/stake.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" strokeLineCap="round"
                                ...
                                <p>Stake</p>
                            </span></a><a class="link" href="/ranking.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" strokeLineCap="round"
                        ...
                        <a class="link" href="/referrals.php"><span class="sidebar_item">
                        ...
                        <a class="link" href="/wallet-connect.php"><span class="sidebar_item"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                        ...
                        <a class="link" href="/copy-experts.php"><span class="sidebar_item"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a class="link"
                            href="/settings.php">
                            <span class="sidebar_item"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                    height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <div class="sc-fjvwmM hJiwgB bottom_section">
            <div class="menu"><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                    ...
                    <p>Settings</p>
                </span><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
